...
public interface DpDriverApi {
     ...
     * @param deviceMetadata
     */
    Boolean addDevice(DeviceMetadata deviceMetadata);
     ...
     * @param data
     */
    void reportWithoutDPData(NonDpData data);
     ...
     * @param data
     */
    void reportWithoutDPDataWithTopic(String topic, NonDpData data);
     ...
     * @return
     */
    OssResult uploadFileV2(String cid, String fileName, byte[] content, Integer timeout);
