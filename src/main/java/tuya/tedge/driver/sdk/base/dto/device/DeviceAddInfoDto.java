...
public class DeviceAddInfoDto {
    ...
    public DeviceAddInfoDto(String id, String name, String description, String productId, String ip, String lat, String lon, String vendorCode, String installLocation, String extendData, Boolean isIpcDev, Map<String, ProtocolProperties> protocolsMap, String serviceId, String onlineStatus, String activeStatus, String cloudDeviceId, List<String> screenType, String parentCloudId, Boolean isScreenDevice, EnumDeviceSource source) {
        this.id = id;
        this.name = name;
